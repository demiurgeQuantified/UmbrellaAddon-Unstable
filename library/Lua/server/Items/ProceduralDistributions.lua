...
ProceduralDistributions.list = {
	...
	Antiques = {
		...
		items = {
			"BookFancy_Bible",
			4,
			"BookFancy_ClassicFiction",
			4,
			"BookFancy_ClassicNonfiction",
			4,
			"LetterHandwritten",
			10,
			"Newspaper",
	...
	ArmyStorageOutfit = {
		...
		items = {
			...
			"Bag_ALICEpack_Army",
			0.1,
			"Bag_HydrationBackpack_CamoEmpty",
			0.05,
			"Bag_Military",
			0.5,
		},
	...
	ArmySurplusCases = {
		...
		items = {
			...
			"Bag_ProtectiveCaseMilitary",
			10,
			"Bag_ProtectiveCaseBulkyMilitary",
			10,
			"Bag_ProtectiveCaseSmallMilitary",
			50,
			"Bag_ProtectiveCaseSmallMilitary",
			20,
		},
	...
	ArmySurplusHeadwear = {
		...
		items = {
			...
			10,
			"Hat_BonnieHat_DesertCamo",
			4,
			"Hat_BonnieHat_DesertCamoNew",
			1,
			"Hat_BonnieHat_MiliusCamo",
			1,
			"Hat_BonnieHat_OliveDrab",
			1,
			"Hat_BonnieHat_TigerStripeCamo",
			1,
			"Hat_GasMask",
			0.5,
			"Hat_PeakedCapArmy",
	...
	ArmySurplusOutfit = {
		...
		items = {
			...
			4,
			"Jacket_ArmyCamoDesertNew",
			2,
			"Jacket_ArmyCamoGreen",
			10,
			"Jacket_ArmyCamoMilius",
			1,
			"Jacket_ArmyCamoTigerStripe",
			1,
			"Jacket_ArmyCamoUrban",
			4,
			"Jacket_ArmyOliveDrab",
			2,
			"PonchoGreenDOWN",
			10,
			"ShemaghScarf_Green",
			...
			"Trousers_CamoDesert",
			4,
			"Trousers_CamoDesertNew",
			1,
			"Trousers_CamoGreen",
			10,
			"Trousers_CamoMilius",
			1,
			"Trousers_CamoTigerStripe",
			1,
			"Trousers_CamoUrban",
			4,
			"Trousers_OliveDrab",
			...
			"Tshirt_CamoDesert",
			4,
			"Tshirt_CamoDesertNew",
			1,
			"Tshirt_CamoGreen",
			10,
			"Tshirt_CamoMilius",
			1,
			"Tshirt_CamoTigerStripe",
			1,
			"Tshirt_CamoUrban",
			4,
			"Tshirt_OliveDrab",
	...
	BackstageCounter = {
		...
		items = {
			...
			0.1,
			"Glasses_Cosmetic_CatsEye",
			0.1,
			"Glasses_Cosmetic_HalfMoon",
			0.1,
			"Glasses_Cosmetic_MonocleLeft",
			0.1,
			"Glasses_Cosmetic_Normal",
			0.1,
			"Glasses_Cosmetic_Normal_HornRimmed",
			0.1,
	...
	BedroomDresserClassy = {
		...
		items = {
			...
			"Paperback_Business",
			2,
			"Paperback_ClassicFiction",
			6,
			"Paperback_Legal",
			2,
			"Paperback_LiteraryFiction",
			6,
			"Paperback_Rich",
			8,
			"Perfume",
	...
	CafeteriaSnacks = {
		...
		items = {
			...
			"Chocolate_Deux",
			1,
			"Chocolate_GalacticDairy",
			1,
			"Chocolate_RoysPBPucks",
			1,
			"Chocolate_Smirkers",
			1,
			"Chocolate_SnikSnak",
	...
	CampingLockers = {
		...
		items = {
			...
			"Tshirt_HuntingCamo",
			1,
			"Tshirt_LongSleeve_HuntingCamo",
			1,
			"SleepingBag_BluePlaid_Packed",
			1,
			"SleepingBag_Camo_Packed",
			0.5,
			"SleepingBag_Cheap_Blue_Packed",
			2,
			"SleepingBag_Cheap_Green2_Packed",
			2,
			"SleepingBag_Cheap_Green_Packed",
			2,
			"SleepingBag_GreenPlaid_Packed",
			1,
			"SleepingBag_Green_Packed",
			1,
			"SleepingBag_HighQuality_Brown_Packed",
			0.5,
			"SleepingBag_RedPlaid_Packed",
			1,
			"SleepingBag_Spiffo_Packed",
			0.05,
			"Bag_ALICEpack",
			0.01,
			"Bag_BigHikingBag",
	...
	CampingStoreCases = {
		...
		items = {
			...
			"Bag_ProtectiveCase",
			10,
			"Bag_ProtectiveCaseBulky",
			10,
			"Bag_ProtectiveCaseSmall",
			20,
			"Bag_ProtectiveCaseSmall",
			10,
			"Cooler",
	...
	CrateCannedFood = {
		...
		items = {
			...
			"CannedCornedBeef",
			6,
			"CannedCornedBeef_Box",
			0.06,
			"CannedFruitBeverage",
			6,
			"CannedFruitBeverage_Box",
			0.06,
			"CannedFruitCocktail",
			6,
			"CannedFruitCocktail_Box",
			0.06,
			"CannedMilk",
			2,
			"CannedMilk_Box",
	...
	ElectronicStorePhones = {
		...
		items = {
			...
			"CordlessPhone",
			10,
			"Mov_BlackModernPhone",
			50,
			"Mov_BlackModernPhone",
			20,
			"Mov_WhiteModernPhone",
			50,
			"Mov_WhiteModernPhone",
			20,
		},
	...
	FossoilCounterCleaning = {
		...
		items = {
			...
			"Sponge",
			10,
			"Hat_BaseballCap_Fossoil",
			8,
			"Hat_BaseballCap_Fossoil02",
			4,
			"Tshirt_Fossoil",
			10,
			"Mov_SignOutOfGas_Fossoil",
			1,
		},
		junk = {
			rolls = 1,
	...
	Gas2GoCounterCleaning = {
		...
		items = {
			...
			"Tshirt_Gas2Go",
			4,
			"Hat_BaseballCap_Gas2Go",
			4,
			"Mov_SignOutOfGas_Gas2Go",
			1,
		},
		junk = {
			rolls = 1,
	...
	MeleeWeapons = {
		...
		items = {
			...
			"KnifeShiv",
			8,
			"LongHandle_Broken_Nails",
			0.5,
			"Plank_Broken_Nails",
			0.5,
			"WoodenStick_Nails",
			1,
			"WoodenStick_Broken_Nails",
			0.5,
			"Bag_GolfBag_Melee",
			0.5,
			"Machete",
		...
		junk = {
			...
			items = {
				...
				"CanoePadelX2_Broken",
				1,
				"FieldHockeyStick_Broken",
				2,
				"GardenToolHandle_Broken",
				2,
				"GuitarAcousticNeck_Broken",
				2,
				"GuitarElectricNeck_Broken",
				2,
				"GuitarElectricBassNeck_Broken",
				2,
				"LongHandle_Broken",
				4,
				"LongStick_Broken",
	...
	MeleeWeapons_Mid = {
		...
		items = {
			...
			"Cudgel_Nails",
			0.1,
			"FieldHockeyStick_Nails",
			0.1,
			"FieldHockeyStick_Broken_Nails",
			0.1,
			"Handle_Nails",
			0.1,
			"Handle_Can",
			...
			"TableLeg_Nails",
			0.1,
			"TableLeg_Broken_Nails",
			0.1,
			"TreeBranch_Can",
			0.1,
			"TreeBranch_Nails",
			0.1,
			"TreeBranch_Railspike",
			0.1,
			"WoodenStick_Nails",
			0.1,
			"WoodenStick_Broken_Nails",
	...
	MeleeWeapons_Late = {
		...
		items = {
			...
			"BaseballBat_Broken_Nails",
			0.1,
			"BaseballBat_GardenForkHead",
			0.1,
			"BaseballBat_Metal_Bolts",
			0.1,
			"BaseballBat_Metal_Sawblade",
			0.1,
			"BaseballBat_RakeHead",
			0.1,
			"BaseballBat_RailSpike",
	...
	SafehouseArmor_Late = {
		...
		items = {
			...
			"GreaveScrap_Left",
			0.1,
			"GreaveSpikeScrap_Left",
			0.01,
			"Greave_Left",
			0.01,
			"ShinKneeGuard_L_Metal",
			0.5,
			"Shoulderpad_Articulated_L_Metal",
			0.01,
			"Shoulderpad_Articulated_R_Metal",
			0.01,
			"Shoulderpad_MetalScrap_L",
			0.5,
			"Shoulderpad_MetalSpikeScrap_L",
			0.01,
			"Shoulderpad_Metal_L",
			0.01,
			"ThighMetal_L",
			0.01,
			"ThighScrapMetalSpike_L",
			0.01,
			"ThighScrapMetal_L",
			0.1,
			"VambraceScrap_Left",
			0.1,
			"VambraceSpikeScrap_Left",
			0.01,
			"Vambrace_Left",
			0.01,
			"Cuirass_Tire",
			...
			"Chainmail_Hand_R",
			0.1,
			"Chainmail_SleeveFull_L",
			0.01,
			"Chainmail_SleeveFull_R",
			0.001,
			"Gloves_FingerlessLeatherGloves",
			8,
			"Gloves_IceHockeyGloves",
	...
	UniversityStorageAnthropology = {
		...
		items = {
			...
			"Earring_BoarTusk",
			1,
			"NecklaceLong_SkullMammal",
			1,
			"NecklaceLong_SkullMammal_Multi",
			1,
			"NecklaceLong_SkullSmall",
			1,
			"NecklaceLong_SkullSmall_Multi",
			1,
			"NecklaceLong_Teeth",
			1,
			"Necklace_BoarTusk",
			1,
			"Necklace_BoarTusk_Multi",
			1,
			"Necklace_SkullMammal",
			1,
			"Necklace_SkullMammal_Multi",
			1,
			"Necklace_SkullSmall",
			1,
			"Necklace_SkullSmall_Multi",
			1,
			"AnimalBone",
			8,
			"Hominid_Skull",
	...
	WildWestClothing = {
		...
		items = {
			...
			8,
			"Shirt_Crafted_DenimRandom",
			4,
			"Suit_Jacket",
			2,
			"Trousers_Crafted_DenimRandom",
			8,
			"Vest_Waistcoat",
			2,
			"Shirt_FormalWhite",
			1,
			"Trousers_SuitWhite_White",
			1,
			"Trousers_Suit",
			2,
		},
