...
AnimalDefinitions.animals["ratbaby"].addTrackingXp = false
...
AnimalDefinitions.animals["ratfemale"].canClimbStairs = true
...
AnimalDefinitions.animals["rat"].canClimbStairs = true
