...
AnimalDefinitions.stages["chicken"].stages["chick"].ageToGrow = 18 * 7
...
AnimalDefinitions.stages["chicken"].stages["hen"].ageToGrow = 12 * 30
...
AnimalDefinitions.animals["chick"].hutches = "hutchhen,hutchturkey"
...
AnimalDefinitions.animals["chick"].collisionSize = 0
AnimalDefinitions.animals["chick"].baseEncumbrance = 10
AnimalDefinitions.animals["chick"].canBePet = true
AnimalDefinitions.animals["chick"].collidable = false
...
AnimalDefinitions.animals["chick"].needMom = false
...
AnimalDefinitions.animals["hen"].fertilizedTimeMax = 14 * 24
AnimalDefinitions.animals["hen"].eggType = "Base.Egg"
AnimalDefinitions.animals["hen"].timeToHatch = 21 * 24
...
AnimalDefinitions.animals["hen"].baseEncumbrance = 20
AnimalDefinitions.animals["hen"].canBePet = true
AnimalDefinitions.animals["hen"].collidable = false
...
AnimalDefinitions.animals["cockerel"].fleeHumansMod = 0.8
...
AnimalDefinitions.animals["cockerel"].collidable = false
...
AnimalDefinitions.animals["cockerel"].minBodyPart = 11
