...
local turkey_poult_sounds = {
	death = {
		name = "AnimalVoiceTurkeyPoultDeath",
		slot = "voice",
		priority = 100,
	},
	idle = {
		name = "AnimalVoiceTurkeyPoultIdle",
		intervalMin = 15,
		intervalMax = 30,
		slot = "voice",
	},
	pain = {
		name = "AnimalVoiceTurkeyPoultPain",
		slot = "voice",
		priority = 50,
	},
	petting = {
	...
	pick_up = {
		name = "PickUpAnimalTurkeyPoult",
		slot = "voice",
		priority = 1,
	},
	pick_up_corpse = {
		name = "PickUpAnimalDeadTurkeyPoult",
	},
	put_down = {
		name = "PutDownAnimalTurkeyPoult",
		slot = "voice",
		priority = 1,
	},
	put_down_corpse = {
		name = "PutDownAnimalDeadTurkeyPoult",
	},
	stressed = {
		name = "AnimalVoiceTurkeyPoultStressed",
		intervalMin = 2,
		intervalMax = 3,
		slot = "voice",
	},
...
AnimalDefinitions.stages["turkey"].stages["turkeypoult"].ageToGrow = 18 * 7
...
AnimalDefinitions.stages["turkey"].stages["turkeyhen"].ageToGrow = 12 * 30
...
AnimalDefinitions.animals["turkeyhen"].minClutchSize = 9
AnimalDefinitions.animals["turkeyhen"].maxClutchSize = 17
AnimalDefinitions.animals["turkeyhen"].layEggPeriodStart = 5
AnimalDefinitions.animals["turkeyhen"].fertilizedTimeMax = 14 * 24
AnimalDefinitions.animals["turkeyhen"].eggType = "Base.TurkeyEgg"
AnimalDefinitions.animals["turkeyhen"].timeToHatch = 28 * 24
...
AnimalDefinitions.animals["gobblers"].fleeHumansMod = 0.8
