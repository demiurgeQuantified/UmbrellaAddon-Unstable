...
AnimalDefinitions.stages["sheep"].stages["lamb"].ageToGrow = 6 * 30
...
AnimalDefinitions.breeds["sheep"].breeds["suffolk"] = {}
...
AnimalDefinitions.breeds["sheep"].breeds["rambouillet"] = {}
...
AnimalDefinitions.breeds["sheep"].breeds["friesian"] = {}
...
AnimalDefinitions.animals["lamb"].feedByHandType = "SheepMilk"
...
AnimalDefinitions.animals["lamb"].happyAnim = 1
...
AnimalDefinitions.animals["ewe"].minAgeForBaby = 7 * 30
AnimalDefinitions.animals["ewe"].maxAgeGeriatric = (10 * 12) * 30
...
AnimalDefinitions.animals["ewe"].matingPeriodStart = 9
AnimalDefinitions.animals["ewe"].matingPeriodEnd = 2
AnimalDefinitions.animals["ewe"].timeBeforeNextPregnancy = (3 * 4) * 7
