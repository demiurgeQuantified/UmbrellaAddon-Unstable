...
AnimalAvatarDefinition["cow"].trailerDir = IsoDirections.SW
AnimalAvatarDefinition["cow"].trailerZoom = 0
AnimalAvatarDefinition["cow"].trailerXoffset = 0.6
AnimalAvatarDefinition["cow"].trailerYoffset = -0.6
AnimalAvatarDefinition["cow"].hook = true
AnimalAvatarDefinition["cow"].butcherHookZoom = -3
AnimalAvatarDefinition["cow"].butcherHookXoffset = 0
AnimalAvatarDefinition["cow"].butcherHookYoffset = 0.55
AnimalAvatarDefinition["cow"].animalPositionSize = 0.6
AnimalAvatarDefinition["cow"].animalPositionX = 0.1
AnimalAvatarDefinition["cow"].animalPositionY = 0.5
AnimalAvatarDefinition["cow"].animalPositionZ = 0.66
...
AnimalAvatarDefinition["bull"].butcherHookZoom = -3
AnimalAvatarDefinition["bull"].butcherHookXoffset = 0
AnimalAvatarDefinition["bull"].butcherHookYoffset = 0.55
AnimalAvatarDefinition["bull"].animalPositionSize = 0.6
AnimalAvatarDefinition["bull"].animalPositionX = 0.1
AnimalAvatarDefinition["bull"].animalPositionY = 0.5
AnimalAvatarDefinition["bull"].animalPositionZ = 0.66
