...
AnimalDefinitions.animals["raccoonsow"].timeBeforeNextPregnancy = 7
...
AnimalDefinitions.animals["raccoonsow"].canClimbStairs = true
...
AnimalDefinitions.animals["raccoonboar"].thirstHungerTrigger =
	AnimalDefinitions.animals["raccoonsow"].thirstHungerTrigger
...
AnimalDefinitions.animals["raccoonboar"].canClimbStairs = true
