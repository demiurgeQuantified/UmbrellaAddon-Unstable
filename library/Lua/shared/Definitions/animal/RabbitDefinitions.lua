...
AnimalDefinitions.breeds["rabbit"].breeds["swamp"].forcedGenes["maxMilk"] = {}
...
AnimalDefinitions.breeds["rabbit"].breeds["appalachian"].forcedGenes["maxMilk"] = {}
...
AnimalDefinitions.breeds["rabbit"].breeds["cottontail"].forcedGenes["maxMilk"] = {}
...
AnimalDefinitions.animals["rabdoe"].minAgeForBaby = 6 * 30
AnimalDefinitions.animals["rabdoe"].pregnantPeriod = 43
AnimalDefinitions.animals["rabdoe"].timeBeforeNextPregnancy = 20
...
AnimalDefinitions.animals["rabbuck"].baseEncumbrance = AnimalDefinitions.animals["rabdoe"].baseEncumbrance
AnimalDefinitions.animals["rabbuck"].canBePet = AnimalDefinitions.animals["rabdoe"].canBePet
AnimalDefinitions.animals["rabbuck"].collidable = AnimalDefinitions.animals["rabdoe"].collidable
