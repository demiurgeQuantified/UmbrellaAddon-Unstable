...
AnimalDefinitions.stages["pig"].stages["piglet"].ageToGrow = 20 * 7
...
AnimalDefinitions.stages["pig"].stages["sow"].ageToGrow = 20 * 7
...
AnimalDefinitions.breeds["pig"].breeds["landrace"].forcedGenes["maxMilk"] = {}
...
AnimalDefinitions.breeds["pig"].breeds["largeblack"].forcedGenes["maxMilk"] = {}
...
AnimalDefinitions.animals["piglet"].litterEatTogether = true
...
AnimalDefinitions.animals["sow"].matingPeriodStart = 9
AnimalDefinitions.animals["sow"].matingPeriodEnd = 2
AnimalDefinitions.animals["sow"].timeBeforeNextPregnancy = 7
