...
--- @param arg0 String
--- @return boolean
--- @overload fun(self: DummySoundEmitter, arg0: long): boolean
...
--- @param arg0 String
--- @return long
--- @overload fun(self: DummySoundEmitter, arg0: String, arg1: boolean): long
--- @overload fun(self: DummySoundEmitter, arg0: String, arg1: IsoGameCharacter): long
--- @overload fun(self: DummySoundEmitter, arg0: String, arg1: IsoGridSquare): long
--- @overload fun(self: DummySoundEmitter, arg0: String, arg1: IsoObject): long
--- @overload fun(self: DummySoundEmitter, arg0: String, arg1: int, arg2: int, arg3: int): long
...
--- @return long
--- @overload fun(self: DummySoundEmitter, arg0: String, arg1: IsoObject): long
--- @overload fun(self: DummySoundEmitter, arg0: String, arg1: boolean, arg2: IsoObject): long
