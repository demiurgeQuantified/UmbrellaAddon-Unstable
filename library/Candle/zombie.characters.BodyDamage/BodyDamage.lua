...
--- @param arg1 float
--- @return void
--- @overload fun(self: BodyDamage, arg0: BodyPartType, arg1: float): void
...
--- @public
--- @return boolean
--- @overload fun(self: BodyDamage, arg0: int): boolean
...
--- @param arg0 Food
--- @return void
--- @overload fun(self: BodyDamage, arg0: Food, arg1: float): void
--- @overload fun(self: BodyDamage, arg0: Food, arg1: float, arg2: boolean): void
...
--- @param arg1 boolean
--- @return void
--- @overload fun(self: BodyDamage, arg0: BodyPartType, arg1: boolean): void
--- @overload fun(self: BodyDamage, arg0: int, arg1: boolean, arg2: boolean): void
...
--- @param arg0 int
--- @return float
--- @overload fun(self: BodyDamage, arg0: BodyPartType): float
