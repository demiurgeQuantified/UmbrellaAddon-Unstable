...
--- @return void
--- @overload fun(self: HandWeapon, arg0: IsoGameCharacter, arg1: WeaponPart): void
--- @overload fun(self: HandWeapon, arg0: WeaponPart, arg1: boolean): void
--- @overload fun(self: HandWeapon, arg0: IsoGameCharacter, arg1: WeaponPart, arg2: boolean): void
...
--- @param arg0 String
--- @return void
--- @overload fun(self: HandWeapon, arg0: WeaponPart): void
...
--- @public
--- @return float
--- @overload fun(self: HandWeapon, arg0: IsoGameCharacter): float
...
--- @public
--- @return int
--- @overload fun(self: HandWeapon, arg0: IsoGameCharacter): int
...
--- @param arg0 String
--- @return float
--- @overload fun(self: HandWeapon, arg0: WeaponPart): float
...
--- @param arg0 WeaponPart
--- @return void
--- @overload fun(self: HandWeapon, arg0: String, arg1: WeaponPart): void
