...
--- @return void
--- @overload fun(self: BaseVehicle, arg0: IsoMovingObject): void
...
--- @return void
--- @overload fun(self: BaseVehicle, arg0: IsoGameCharacter, arg1: HandWeapon): void
...
--- @return void
--- @overload fun(self: BaseVehicle, arg0: IsoDeadBody, arg1: IsoPlayer): void
function BaseVehicle:addAnimalFromHandsInTrailer(arg0, arg1) end

--- @public
--- @param arg0 IsoAnimal
--- @return void
--- @overload fun(self: BaseVehicle, arg0: IsoDeadBody): void
...
--- @param arg3 String
--- @return void
--- @overload fun(self: BaseVehicle, arg0: IsoPlayer, arg1: BaseVehicle, arg2: String, arg3: String, arg4: Boolean): void
...
--- @public
--- @return void
--- @overload fun(self: BaseVehicle, arg0: boolean): void
...
--- @param arg1 IsoGameCharacter
--- @return boolean
--- @overload fun(self: BaseVehicle, arg0: int, arg1: IsoGameCharacter, arg2: Vector3f): boolean
...
--- @param arg1 IsoGameCharacter
--- @return float
--- @overload fun(self: BaseVehicle, arg0: String, arg1: float, arg2: float, arg3: float): float
...
--- @param arg1 Vector3f
--- @return Vector3f
--- @overload fun(self: BaseVehicle, arg0: float, arg1: float, arg2: float, arg3: Vector3f): Vector3f
...
--- @overload fun(self: BaseVehicle, arg0: float, arg1: float, arg2: float, arg3: Vector3f): Vector3f
--- @overload fun(self: BaseVehicle, arg0: float, arg1: float, arg2: float, arg3: Vector3f, arg4: VehicleScript): Vector3f
...
--- @param arg0 IsoZombie
--- @return void
--- @overload fun(self: BaseVehicle, arg0: IsoAnimal): void
--- @overload fun(self: BaseVehicle, arg0: IsoGameCharacter, arg1: HitVars): void
...
--- @param arg0 int
--- @return boolean
--- @overload fun(self: BaseVehicle, arg0: IsoGameCharacter, arg1: int): boolean
...
--- @param arg0 IsoGridSquare
--- @return boolean
--- @overload fun(self: BaseVehicle, arg0: int, arg1: int, arg2: int): boolean
...
--- @param arg1 String
--- @return void
--- @overload fun(self: BaseVehicle, arg0: int, arg1: String, arg2: IsoGameCharacter): void
...
--- @public
--- @return void
--- @overload fun(self: BaseVehicle, arg0: String): void
...
--- @param arg2 BitSet
--- @return void
--- @overload fun(self: BaseVehicle, arg0: long, arg1: GameSoundClip, arg2: BitSet): void
...
--- @param arg1 boolean
--- @return int
--- @overload fun(self: BaseVehicle, arg0: IsoMovingObject, arg1: float, arg2: float, arg3: boolean): int
...
--- @param arg1 GameSoundClip
--- @return void
--- @overload fun(self: BaseVehicle, arg0: long, arg1: GameSoundClip): void
